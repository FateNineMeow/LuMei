...
using System.Text;
using Ezhu.AutoUpdater.Lib.ICCEmbedded.Checksums;
using Ezhu.AutoUpdater.Lib.ICCEmbedded.Core;
using Ezhu.AutoUpdater.Lib.ICCEmbedded.Encryption;
using Ezhu.AutoUpdater.Lib.ICCEmbedded.Zip.Compression;
using Ezhu.AutoUpdater.Lib.ICCEmbedded.Zip.Compression.Streams;
#if !NETCF_1_0
#endif

namespace Ezhu.AutoUpdater.Lib.ICCEmbedded.Zip 
{
			...
			try {
				...
				while ( testing && (entryIndex < Count) ) {
					...
					if ( testing && testData && this[entryIndex].IsFile ) {
						...
						Stream entryStream = GetInputStream(this[entryIndex]);
